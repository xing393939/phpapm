...
if [ 1 -eq $1 ] ; then
    callact2 "/usr/local/php/bin/php crontab.php act=P1D_ClickStats master=yes"
    ...
    #callact2 "/usr/local/php/bin/php crontab.php act=monitor_check master=yes"
    callact2 "/usr/local/php/bin/php crontab.php act=oci_explain master=yes"
fi