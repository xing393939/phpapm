...
ALTER TABLE  `phpapm_monitor` CHANGE  `FUN_COUNT`  `FUN_COUNT` INT( 11 ) UNSIGNED NULL DEFAULT  '0';
ALTER TABLE  `phpapm_monitor_date` CHANGE  `FUN_COUNT`  `FUN_COUNT` INT( 11 ) UNSIGNED NULL DEFAULT  '0';
ALTER TABLE  `phpapm_monitor_hour` CHANGE  `FUN_COUNT`  `FUN_COUNT` INT( 11 ) UNSIGNED NULL DEFAULT  '0';
